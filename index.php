...
<h2 class="gradient_policy">Bienvenue sur mon portfolio !</h2>
    ...
    <nav class="navbar">
        <ul class="nav-menu">
            <li class="nav-item">
                <a href="propos.html" class="blue_btn">À propos</a>
            </li>
            <li class="nav-item">
                <a href="langage.html" class="blue_btn">Langages</a>
            </li>
            <li class="nav-item">
                <a href="conception.html" class="blue_btn">Conception</a>
            </li>
            <li class="nav-item">
                <a href="cv.html" class="blue_btn">CV</a>
            </li>
        </ul>
    </nav>
...
<section class="main-section">
    <div class="features">
        ...
        <div class="feature">
            ...
            <div class="feature-text">J'apprends certains langages de programmation. <a href="langage.html" class="link-to-page">Cliquez ici</a> pour voir la liste</div>
        </div>
    </div>
</section>
