...
<h2 class="gradient_policy">Bienvenue sur mon portfolio !</h2>
    ...
    <nav class="navbar">
        <ul class="nav-menu">
            <li class="nav-item">
                <a href="propos.php" class="blue_btn">À propos</a>
            </li>
            <li class="nav-item">
                <a href="langage.php" class="blue_btn">Langages</a>
            </li>
            <li class="nav-item">
                <a href="conception.php" class="blue_btn">Conception</a>
            </li>
            <li class="nav-item">
                <a href="cv.php" class="blue_btn">CV</a>
            </li>
        </ul>
    </nav>
